...
const PostForm = ({ values, handleSubmit, submitting, t }) => {
  ...
  const [imageBase64, setImageBase64] = useState(values.imageBase64);
  ...
  useEffect(() => {
    setImageBase64(values.imageBase64);
  ...
  return (
    <Form name="post" onSubmit={handleSubmit}>
      ...
      <ImageUpload
        ...
        onImageBase64Change={imageBase64 => {
          console.log('image upload event fired');
          if (imageBase64) {
            setImageBase64(imageBase64);
          } else {
            setImageBase64(originalValues.current.imageBase64);
          }
        }}
      />
